...
use User\UseCase\Fire\Command;
use User\UseCase\Fire\Handler;

/**
 * Class Fire
 * @package App\Http\Handler\Admin\Fire
 * @Route(path="/admin/user/fire/{uuid}", name="admin.user.fire", methods={"PATCH"})
 */
final class Fire
{
